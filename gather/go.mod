...
require (
	...
	github.com/enterprise-contract/go-gather/gather/k8s_p v0.0.0
...
require (
	...
	github.com/enterprise-contract/go-gather/metadata/k8s_p v0.0.0 // indirect
...
replace (
	...
	github.com/enterprise-contract/go-gather/gather/k8s_p => ./k8s_p
	...
	github.com/enterprise-contract/go-gather/metadata/k8s_p => ../metadata/k8s_p
